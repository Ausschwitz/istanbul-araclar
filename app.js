...
function generateSeoText(car) {
  return `İstanbul Makina VIP Escort Galerisi içinde yer alan ${car.name}, dikkat çekici profillerden biridir. Yaşı ${car.age}, boyu ${car.height}, kilosu ${car.weight} ile öne çıkar. ${car.description ? car.description + "." : "Kendine has tarzı ve dikkat çeken yapısıyla öne çıkar."}`;
}

const defaultSettings = {
  title: "İstanbul Makina Vip Escortlar",
